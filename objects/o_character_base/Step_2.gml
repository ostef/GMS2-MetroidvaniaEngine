...
debug_draw_text(x, y + 4 * 5, "collisions (r, l, b, t): " + 
	string(bCollisionRight) + ", " +
	string(bCollisionLeft) + ", " +
	string(bCollisionBottom) + ", " +
	string(bCollisionLeft), c_white, fa_center, fa_top);